...
namespace CGLabsTest
{
    public class Tests
    {
        ...
        public void NormalizeTest()
        {
            ...
            new Vector(1, 0, 0).Should().BeEquivalentTo(normalized, options => 
        ...
        public void OperatorMinTest()
        {
            ...
            new Vector(-1, -2,-3).Should().BeEquivalentTo(minVectorA, options => 
                options.ExcludingMissingMembers());
            new Vector(-4, -1,-4).Should().BeEquivalentTo(aMinB, options => 
                options.ExcludingMissingMembers());
        }
        ...
        public void OperatorPlusTest()
        {
            ...
            new Vector(6, 5,10).Should().BeEquivalentTo(aPlusB, options => 
                options.ExcludingMissingMembers());
        }
